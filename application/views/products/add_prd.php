...
<div class="products">
    ...
    <div class="products-content" style="margin-bottom: 25px;">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-4 padd-0">
                        ...
                        <input type="hidden" value="<?= $data['parent_id'] ?>" id="prd_parent_id">
                    </div>
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-md-6 hidden  padd-right-0">
                                    <label>Kho</label>
                                    <div class="col-md-12 padd-0">
                                        <select class="form-control" id="prd_store_id">
                                            <optgroup label="Chọn kho để lưu trữ">
                                                <?php if (isset($data['_prd_store']) && count($data['_prd_store'])):
                                                    foreach ($data['_prd_store'] as $key => $item) :
                                                        ?>
                                                        <option value="<?php echo $item['ID']; ?>" selected="selected"><?php echo $item['stock_name']; ?></option>
                                                    <?php
                                                    endforeach;
                                                endif;
                                                ?>
        ...
        <div class="col-md-12 hidden   application-views-producs-add_prd.php">
                            <div class="row">
        ...
        <div class="expand-info  hidden application-views-producs-add_prd.php">
            <div class="row">
                <div class="col-md-12">
