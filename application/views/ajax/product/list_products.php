<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <th class="text-center hidden">Hình ảnh</th>
    ...
    <?php if (isset($data['_list_product']) && count($data['_list_product'])) :
        foreach ($data['_list_product'] as $key => $item) : ?>
            <tr>
                ...
                <td class="text-center hidden app-view-ajax-product-list_products.php">
                  <?php echo (!empty($item['prd_image_url'])) ? "<img src='{$item['prd_image_url']}' alt='{$item['prd_name']}' width='50' height='50'/>" : '<i class="fa fa-cloud-upload" style="font-size: 18px; color: #337ab7; cursor: pointer; "></i>' ?>
              </td>
