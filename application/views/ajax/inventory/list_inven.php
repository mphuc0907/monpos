...
<?php 
/*
echo 'option1 = ' . $cf_test_option1 . ', ' . 'option2 = ' . $cf_test_option2 . ', ' . 'option3 = ' . $cf_test_option3;

echo '</br> Tong sp ' . $codefly_total_prd;

echo '</br> keywords = ' . $codefly_option_keyword;
*/
 ?>
...
<table class="table table-bordered table-striped page-hien-tai_<?php echo $pagenumber_codefly_test;?>">
    <thead>
    <tr>
        <th class="text-center">Mã hàng</th>
        <th class="text-center">Tên sản phẩm</th>
        <th class="text-center">SL</th>
        <th class="text-center views-ajax-inventory-list_item">Vốn tồn kho</th>
