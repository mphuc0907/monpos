            ...
            <div class="col-md-6">
                <div class="right-action text-right">
                    <div class="btn-groups">
                        <button type="button" class="btn btn-primary hidden"  onclick="cms_save_orders(0)">
                    ...
                    <div class="col-md-12 p-0">
                        <div class="morder-info" style="padding: 4px;">
                            <div class="tab-contents">
                                ...
                                <div class="form-group hidden marg-bot-10 clearfix">
                                    <div style="padding:0px" class="col-md-6">
                                    ...
                                    <div class="col-md-6 p-0">
                                        <select class="form-control" id="store_id_orders">
                                            ...
                                            <?php foreach ($data['store_id'] as $key=> $item) { ?>
                                                <option
                                                        value="<?php echo $item['ID']; ?>" selected="selected"><?php echo $item['stock_name']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12 p-0">
                        ...
                        <div class="morder-info">
                            <div class="tab-contents">
                                ...
                                <div class="form-group marg-bot-10 clearfix">
                                    <div class="col-md-6 p-0">
                                        <label class="debts">Còn nợ</label>
                                    </div>
                                    <div class="col-md-6 p-0">
