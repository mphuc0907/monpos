    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <th class="text-center">
                <select style="text-align:center; border:none; background:none;" id="customer-id">
        ...
        <?php if (isset($_list_orders) && count($_list_orders)) :
            foreach ($_list_orders as $key => $item) :
                ...
                <tr>
                    ...
                    <td class="text-center"
                        style="background: #fff;"><p><?php echo cms_encode_currency_format($item['lack']); ?></p></td>
                    <td class="text-center" style="background: #fff;">
                        <?php if($item['lack'] > 0): ?>
                        <i title="thanh toán nợ " data-toggle="modal"
                           data-target="#pay_lack" data-id="<?php echo $item['ID']; ?>" data-lack="<?php echo ($item['lack']); ?>"
                           class="fa fa-wrench red update_box_lack"
                                ...
                                <div class="tab-pane active">
                                    <div class="alert alert-success clearfix" style="display: flex;">
                                        ...
                                        <div class="padding-left-10">
                                            ...
                                            <label><?php echo cms_encode_currency_format($item['total_price']); ?> &#273;
                                            </label>
                                        </div>
                                        <div class="padding-left-10">
                                            ...
                                            <label><?php echo cms_encode_currency_format($item['coupon']); ?> &#273;
                                            </label>
                                        </div>
                                        <div class="padding-left-10">
                                            ...
                                            <label><?php echo cms_encode_currency_format($item['total_money']); ?> &#273;
                                            </label>
                                        </div>
                                        <div class="padding-left-10">
                                            ...
                                            <label
                                                ><?php echo cms_encode_currency_format($item['lack']); ?> &#273;
                                            </label>
                                        </div>
                                    </div>
...
<script>
    $(document).on("click", ".update_box_lack", function () {
        var myid = $(this).data('id');
        var mylack= $(this).data('lack');
        $("#pay_lack #id_bill_lack").val( myid );
        $("#pay_lack #id_status_pay").val( 1 );
        $("#pay_lack #lack_pay").attr({
            "max" : mylack,        // substitute your own
