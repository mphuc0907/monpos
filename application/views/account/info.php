                    ...
                    <div class="form-hide form-change-password" style="display: none;">
                        <div>
                            <div class="form-group">
                                ...
                                <input type="text" id="oldpass" class="form-control" placeholder="Mật khẩu hiện tại">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control new-password" id="renewpass" placeholder="Nhập lại mật khẩu mới">
