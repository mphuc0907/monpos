<div class="login-container" id="login-form">
    ...
    <div class="login-frame clearfix">
        <center><h3 class="heading   padd-0"><i class="fa fa-lock"></i>Đăng nhập</h3></center>
        ...
        <div class="form-sigin">
            <form class="form-horizontal login-form frm-sm" method="post" action="">
                <div class="form-group input-icon">
                    <label for="inputEmail4" class="sr-only control-label">Tài khoản gian hàng </label>
                    <input type="text" name="data[parent_user]"
                           value="<?php echo cms_common_input(isset($_post) ? $_post : [], 'parent_user'); ?>"
                           class="form-control" id="inputEmail4" placeholder="Tài khoản gian hàng">
                    <i class="fa fa-user icon-right"></i>
                </div> <div class="form-group input-icon">
