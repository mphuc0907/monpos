...
<div class="setting">
    <ul class="nav nav-tabs tab-setting" role="tablist">
        ...
        <li role="presentation"><a href="#print" aria-controls="print" role="tab" data-toggle="tab">Mẫu hóa
                đơn</a></li>
        <li role="presentation"><a href="#stores" aria-controls="stores" role="tab"
                                   data-toggle="tab">Kho</a>
        </li><li role="presentation">
            <a href="#banks" aria-controls="banks" role="tab"
                                   data-toggle="tab">Ngân hàng</a>
        </li>
    </ul>
    <div class="tab-content">
                                    ...
                                    if ($user['group_id'] != 1) {
                                        ...
                                        <tr class="tr-item-<?php echo $val['id']; ?>">
                                            ...
                                            <td class="text-center"><i class="fa fa-pencil-square-o edit-item"
                                                        ...
                                                        onclick="cms_del_usitem(<?php echo $val['id']; ?>)"
                                                        title="Xóa <?php echo $val['id'] ?>"
                                                        class="fa fa-trash-o delete-item xoa"
                                        ...
                                        <tr class="edit-tr-item-<?php echo $val['id']; ?>" style="display: none;">
                                            ...
                                            <td class="itgroup_name">
                                                <div class="group-user">
                                                    <?php
                                                    if ($val['group_name'] == 'Ban giám đốc') {
                                                        ?>
                                                        <?php echo '<span class="user_group"><i class="fa fa-male"></i> ' . $val['group_name'] . '</span>'; ?>
                                                        <?php
                                                    } else {
                                                        ?>
                                                        <div class="group-selbox" data-action="">
                                                        </div>
                                                        <?php
                                                    } ?>
                                        ...
                                        if ($val['group_name'] == "Admin" || $val['group_name'] == "Ban giám đốc") {
                                            $ind++;
                                            ?>
                                            <tr class="tr-item-<?php echo $val['id']; ?>">
                                                <td class="text-center"><?php echo $ind; ?></td>
                                                ...
                                                <td><?php echo ($val['display_name'] != '') ? $val['display_name'] : '-'; ?></td>
                                                <td><?php echo $val['email']; ?></td>
                                                <td><span class="user_group"><i
                                                                class="fa fa-male"></i> <?= ($user['group_id'] == 1) ? (($val['group_name'] == 'Ban giám đốc') ? 'Khách hàng' : $val['group_name']) : $val['group_name']; ?></span>
                                                </td>
                                                <td class="text-center"><?php echo cms_render_html($val['user_status'], 'user_status', ['fa-unlock', 'fa-lock'], ['Hoạt động', 'Tạm ngừng']); ?></td>
                                                <td class="text-center"><i class="fa fa-pencil-square-o edit-item"
                                                                           title="Sửa"
                                            ...
                                            <tr class="edit-tr-item-<?php echo $val['id']; ?>" style="display: none;">
                                                ...
                                                <td><?php echo '<span class="user_group"><i class="fa fa-male"></i> ' . ($user['group_id'] == 1) ? (($val['group_name'] == 'Ban giám đốc') ? 'Khách hàng' : $val['group_name']) : $val['group_name'] . '</span>'; ?></td>
                                                <td class="text-center ituser_status">
                                                    <select class="ituser_status form-control">
                                                        <option
                                                                value="1" <?php echo ($val['user_status'] == '1') ? 'selected="selected"' : ''; ?>>
                                                ...
                                                <td class="text-center"><i class="fa fa-floppy-o" title="Lưu"
                                                                           onclick="cms_save_item_user( <?php echo $val['id']; ?> )"
                                                                           style="color: #EC971F; cursor: pointer; margin-right: 10px;"></i><i
                                                            onclick="cms_undo_item( <?php echo $val['id']; ?> )"
                                                            title="Hủy"
                                                            class="fa fa-undo"
                                                            style="color: green; cursor: pointer; margin-right: 5px;"></i>
                                                </td>
        ...
        <div role="tabpanel" class="tab-pane" id="stores">
            <div class="panel panel-primary" style="margin-top: 20px">
                <div class="panel-heading add_butn_them">
                    <i class="fa fa-users"></i> Danh sách kho
                    <div class="action pull-right hide_kho_full">
                        <button class="btn btn-default btn-sm create-group btn-in-panel blue" data-toggle="modal"
...
<script>
    function cms_loaduser(id) {
        var $url = 'ajax/cms_upuser';
        var $param = {
            'type': 'POST',
            'url': $url,
            'data': {
