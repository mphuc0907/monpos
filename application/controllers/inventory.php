...
class Inventory extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $parent = ($user_id['group_id'] == 1) ? 1 : (($user_id['parent_id'] == 1) ? $user_id['id'] : $user_id['parent_id']);
    ...
    public function cms_paging_inventory($page = 1)
    {
        ...
        $data['pagenumber_codefly_test'] = $page;
        $data['cf_test_option1'] = $option['option1'];
        $data['cf_test_option2'] = $option['option2'];
        $data['cf_test_option3'] = $option['option3'];
        $data['codefly_total_prd'] = $total_prd;
        $data['codefly_option_keyword'] = $option['keyword'];
    ...
    public function ExportInventory()
    {
        ...
        $data['data']['_list_product'] = $this->db->select('ID,prd_code,prd_name,prd_sls,prd_sell_price,prd_origin_price')->where(['prd_status' => 1, 'deleted' => 0, 'prd_sls >' => 0,'shop_id',$parent])->from('products')->order_by('created', 'desc')->get()->result_array();
